...
@UIApplicationMain
class AppDelegate: UIResponder, UIApplicationDelegate, WatchConnectionManagerPhoneDelegate {
    ...
    func connectionManager(_ connectionManager: ConnectionManager, updatedWithResponse response: String) {
        ...
        let alert = UIAlertController(title: "Collect Your Reward", message: "Your daily quests through the Apple Watch have granted you \(response) gold!", preferredStyle: .actionSheet)
        
        alert.addAction(UIAlertAction(title: "Collect Reward", style: .default, handler: { action in
